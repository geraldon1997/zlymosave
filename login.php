...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $u = new User($_POST);
    $u->loginController();
        echo "<div class='loginfo' id='logerror'>
                $u->logerr
            </div>
            <script>
                setTimeout(function(){
...
<head>
    ...
    <meta content="Prince Le" name="author">
    <!-- Favicon -->
    ...
    <div class="container">
        <div class="row">
            <div class=" mt-90 col-lg-8 col-lg-offset-2">
                <div class="row">
                    <div class="login-wrapper crypto shadow">
                        ...
                        <div class="col-lg-7 col-sm-12">
                            <div id="login" class="login loginpage mt-0 no-pl no-pr pt30 pb30">    
                                ...
                                <p id="nav" class="over-h">
                                    <a class="pull-left blue-text" href="forgotpassword.php" title="Password Lost and Found">Forgot password?</a>
